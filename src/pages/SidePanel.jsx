...
const SidePanel = () => {
  ...
  return (
    <div className="w-full text-white flex flex-col justify-start items-center px-5 py-10 gap-5 relative">
      ...
      <div
        className={`${
          hide == true ? "border-none" : "border-b-2 border-[#373837] w-full"
